  ...
  return (
    <div className="min-h-screen bg-background flex flex-col items-center justify-center p-6 relative overflow-hidden">
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-5 max-w-3xl w-full animate-fade-in"
        ...
        <Link to="/user-login"  className="group relative overflow-hidden rounded-2xl p-7 border transition-all duration-300 hover:-translate-y-1 flex flex-col items-center text-center md:col-start-2"
          style={{
